  ...
  return (
    <div className="about py-20 px-4 mb-8 md:px-20">
      <div className="lg:w-8/12 w-full">
        <h1 className="text-5xl lg:text-8xl text-gray-600 font-bold mb-6">ABOUT US</h1>
        <p className="text-gray-100 text-base md:text-lg leading-8 md:leading-loose my-10">Unlock your brand's potential with Virall's integrated marketing solutions, designed to deliver measurable returns and drive sustainable growth.</p>
        ...
        <p className="text-lg text-gray-600 font-semibold mt-10">Do you have a project that needs pro-expertise?</p>
